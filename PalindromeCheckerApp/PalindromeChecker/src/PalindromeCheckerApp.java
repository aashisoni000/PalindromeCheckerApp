...
class PalindromeService {
     ...
     * Exposes checkPalindrome() method using the internal Stack (UC5 logic).
     */
    public boolean checkPalindrome(String input) {
        if (input == null) return false;

        // UC10 logic integrated within the service
...
public class PalindromeCheckerApp {
    ...
    public static void main(String[] args){
        ...
        boolean isPalindromeUC11 = service.checkPalindrome(input);
        System.out.println("UC11 (OOPS Service) Result: " + (isPalindromeUC11 ? "IS a palindrome" : "is NOT a palindrome"));
